...
// export const dbHttpGet = (path, params) =>
//   dbAxios
//     .get(path, { params, ...options })
//     .then(handleHTTPSuccess)
//     .catch(handleHTTPError);
// export const dbHttpPost = (path, body, config) =>
//   dbAxios
//     .post(path, body, { ...options, ...config })
//     .then(handleHTTPSuccess)
//     .catch(handleHTTPError);
// export const dbHttpPatch = (path, body) =>
//   dbAxios
//     .patch(path, body, options)
//     .then(handleHTTPSuccess)
//     .catch(handleHTTPError);
// export const dbHttpPut = (path, body) =>
//   dbAxios
//     .put(path, body, options)
//     .then(handleHTTPSuccess)
//     .catch(handleHTTPError);
// export const dbHttpDelete = (path, body) =>
//   dbAxios
...
//   axios.put(path, body, options).then(handleHTTPSuccess).catch(handleHTTPError);
